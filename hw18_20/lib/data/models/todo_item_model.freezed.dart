...
class _$TodoItemModelImpl extends _TodoItemModel {
  ...
  @override
  String toString() {
    return 'TodoItemModel(id: $id, title: $title, description: $description, userId: $userId, isCompleted: $isCompleted, order: $order, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
