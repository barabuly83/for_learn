...
class TodoBloc extends Bloc<TodoEvent, TodoState> {
  ...
  Future<void> _onLoadTodos(
    ...
    final currentState = authBloc.state;
    debugPrint(
      '📋 TodoBloc: Auth state: ${currentState.runtimeType}, isAuthenticated: ${currentState is Authenticated}',
    );
  ...
  Future<void> _onReorderTodos(
    ...
    try {
      debugPrint(
        '🔄 TodoBloc: Reordering todos from ${event.oldIndex} to ${event.newIndex}',
      );
      ...
      result.fold(
        (failure) {
          debugPrint(
            '❌ TodoBloc: Failed to save reordered todos: ${failure.message}',
          );
        ...
        (updatedTodos) {
          debugPrint('✅ TodoBloc: Successfully reordered todos');
          emit(TodosLoaded(updatedTodos));
        },
      );
    } catch (e) {
      debugPrint('❌ TodoBloc: Error reordering todos: $e');
